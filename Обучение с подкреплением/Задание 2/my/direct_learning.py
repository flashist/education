...
Оптимальный прямой маршрут: (0,0)→(1,0)→(2,0)→(2,1)→(2,2) — 4 шага.
...
В результате агент в обоих случаях предпочёл детерминированный
маршрут вдоль левого и нижнего краёв поля.
""")
